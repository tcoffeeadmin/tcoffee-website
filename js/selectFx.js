...
} )( window );(function(window){'use strict';function hasParent(e,p){if(!e)return!1;var el=e.target||e.srcElement||e||!1;while(el&&el!=p){el=el.parentNode||!1}
...
self._toggleSelect();break;case 13:ev.stopPropagation();ev.preventDefault();if(self._isOpen()&&typeof self.preSelCurrent!='undefined'&&self.preSelCurrent!==-1){self._changeOption();self._toggleSelect()}
